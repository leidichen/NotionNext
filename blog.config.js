...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lenband', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Reddy', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://week.lenband.com', // 网站地址
